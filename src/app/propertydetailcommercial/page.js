...
const PropertyListingPage = () => {
  ...
  const properties = [
    {
      id: 1,
      title: "Luxury Commercial Apartment in Mayfair -Test",
      location: "London",
      price: 200,
      priceType: "/weekly",
      beds: 2,
    ...
    },
    {
      ...
      latest: true,
      badges: ['Commercial', 'Under Offer', '1 FP', 'EPC']
    },
    {
      id: 3,
      ...
      latest: true,
      badges: ['Commercial', 'Under Offer', 'Out of Stock']
    }
  ];
  ...
  const getBadgeColor = (badge) => {
    switch (badge) {
      ...
      case 'Commercial': return 'bg-orange-500 text-white';
